...
print("\nYour command line input:",sys.argv) # print out the command line input

# Process command line arguments
if (len(sys.argv) < 8):
    print("argv too short, usage: python3 swampLife.py <Number of Ducks> <Number of Newts> <Number of Shrimps> <Number of Algae> <Number of Rocks> <Number of Timesteps> <Movement Type>")
    print('Using default values for <Number of Ducks: 5> <Number of Newts: 5> <Number of Shrimps: 5> <Number of Algae: 5> <Number of Rocks: 5> <Number of Timesteps: 15> <Movement Type: V>')
    # Default values
    userDuck = 5
    userNewt = 5
    userShrimp = 5
    ...
    userDuck = int(sys.argv[1]) # user-definable duck's numbers
    userNewt = int(sys.argv[2]) # user-definable newt's numbers
    userShrimp = int(sys.argv[3]) # user-definable shrimp's numbers
    userAlga = int(sys.argv[4]) # user-definable alga's numbers
    userRock = int(sys.argv[5]) # user-definable rock's numbers
    userTime = int(sys.argv[6]) # user-definable timeteps
    moveType = str(sys.argv[7].upper()) # user-definable movement type (M - Moore / V - von Neumann)
    ...
    if  moveType == "M" or moveType == "MOORE":
        ...
        print("Movement type      :", moveType)
        print("\n***Invalid movement type " + '"' + str(moveType) + '"' + " entered") 
        print('***Next time, use "M" for Moore / "V" for von Neumann')
        print("***Using default movement: von Neumann")

    print("\nInitial count      : " + str(userDuck) + " Ducks, " + str(userNewt) + " Newts, " + str(userShrimp) + " Shrimps, " + str(userAlga) + " Algae, " + str(userRock) + " Rocks")
...
# Timesteps: Logs of animals' states & positions in each timesteps 
    ...
    print("\nYour command line input:",sys.argv) # print out the program's name
    if (len(sys.argv) < 8):
        print("Warning: argv too short, usage: python3 swampLife.py <Number of Ducks> <Number of Newts> <Number of Shrimps> <Number of Algae> <Number of Rocks> <Number of Timesteps> <Movement Type>")
        print('Using default values for <Number of Ducks: 5> <Number of Newts: 5> <Number of Shrimps: 5> <Number of Algae: 5> <Number of Rocks: 5> <Number of Timesteps: 15> <Movement Type: V>')
